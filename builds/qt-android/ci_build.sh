...
export MALAMUTE_ROOT="/tmp/malamute"
git clone https://github.com/zeromq/malamute $MALAMUTE_ROOT

export BIOSPROTO_ROOT="/tmp/biosproto"
git clone https://stash.mbt.lab.etn.com/bios/libbiosproto $BIOSPROTO_ROOT

export LUA_ROOT="/tmp/lua"
git clone https://github.com/lua/lua $LUA_ROOT
